            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex sm:items-center">
                    ...
                    <x-dropdown align="left" width="48">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-md font-medium leading-5 transition duration-150 ease-in-out focus:outline-hidden text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:text-gray-700 focus:border-gray-300">
                                {{ __('My Jobs') }}
                                <div class="ms-1">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="border-t border-gray-200 pt-2">
                ...
                <a href="{{ route('employer.login') }}" class="block pl-8 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-green-600 hover:text-green-800 hover:bg-green-50 hover:border-green-300 focus:outline-hidden focus:text-green-800 focus:bg-green-50 focus:border-green-300 transition duration-150 ease-in-out">
